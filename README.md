...
**APIs.json:** [https://aws.amazon.com/security-hub/](https://aws.amazon.com/security-hub/)
...
- **Base URL:** `https://securityhub.{region}.amazonaws.com`
...
- [OpenAPI](openapi/amazon-security-hub-openapi.yml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Postman Collection](collections/amazon-security-hub.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/amazon-security-hub.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)
- [JSON Schema](json-schema/amazon-security-hub-finding-schema.json) — [JSON Schema](https://json-schema.org/specification)
...
- [API Reference](https://docs.aws.amazon.com/securityhub/latest/APIReference/)
...
- [F A Q](https://aws.amazon.com/security-hub/faqs/)
...
- [Stack Overflow](https://stackoverflow.com/questions/tagged/aws-security-hub)
- [Knowledge Center](https://repost.aws/knowledge-center)
- [Spectral Rules](rules/amazon-security-hub-spectral-rules.yml)
- [Vocabulary](vocabulary/amazon-security-hub-vocabulary.yaml)
- [Features](undefined)
- [Use Cases](undefined)
- [Integrations](undefined)
- [JSON-LD](json-ld/amazon-security-hub-context.jsonld) — [JSON-LD](https://www.w3.org/TR/json-ld11/)
- [JSON Structure](json-structure/amazon-security-hub-finding-structure.json)
